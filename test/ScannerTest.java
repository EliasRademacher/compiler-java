...
public class ScannerTest extends TestCase {
    ...
    private FileReader numbersFileReader;
    private FileReader program1FileReader;

    @Override
    public void setUp() throws Exception {
        scanner = new Scanner();
        numbersFileReader = new FileReader("testResources/numbers.cm");
        program1FileReader = new FileReader("testResources/program1.cm");
    }

    @Override
    public void tearDown() throws Exception {
        numbersFileReader.close();
    }
    ...
    public void testGetNextChar() throws FileNotFoundException {
        ...
        for (char expectedChar: expectedChars) {
            char nextChar = (char) scanner.getNextChar(numbersFileReader);
    ...
    public void testGetToken() throws Exception {
        ...
        expectedTokens.add(Token.SEMI);
        expectedTokens.add(Token.ID);
        expectedTokens.add(Token.ASSIGN);
        expectedTokens.add(Token.INT);
        expectedTokens.add(Token.SEMI);
        ...
        expectedTokens.add(Token.ASSIGN);
        expectedTokens.add(Token.INT);
        expectedTokens.add(Token.PLUS);
        expectedTokens.add(Token.INT);
        expectedTokens.add(Token.TIMES);
        expectedTokens.add(Token.ID);
        expectedTokens.add(Token.SEMI);
